...
public class Level5 extends Level {
    ...
    public void setup() {
        ...
        EnemyEyeball enemyEyeball = new EnemyEyeball(1251, 1251, 2, 100, 10, 22, 22);
        enemyEyeball.setImage(loadImage("../assets/sprites/eyeball.png"));
        enemies.add(enemyEyeball);
        enemyEyeball = new EnemyEyeball(1315, 1315, 2, 100, 10, 22, 22);
        enemyEyeball.setImage(loadImage("../assets/sprites/eyeball.png"));
        enemies.add(enemyEyeball);
        enemyEyeball = new EnemyEyeball(451, 451, 2, 100, 10, 22, 22);
        enemyEyeball.setImage(loadImage("../assets/sprites/eyeball.png"));
        enemies.add(enemyEyeball);
        enemyEyeball = new EnemyEyeball(803, 803, 2, 100, 10, 22, 22);
        enemyEyeball.setImage(loadImage("../assets/sprites/eyeball.png"));
        enemies.add(enemyEyeball);
        enemyEyeball = new EnemyEyeball(1379, 1379, 2, 100, 10, 22, 22);
        enemyEyeball.setImage(loadImage("../assets/sprites/eyeball.png"));
        enemies.add(enemyEyeball);
        enemyEyeball = new EnemyEyeball(259, 259, 2, 100, 10, 22, 22);
        enemyEyeball.setImage(loadImage("../assets/sprites/eyeball.png"));
        enemies.add(enemyEyeball);
        enemyEyeball = new EnemyEyeball(163, 163, 2, 100, 10, 22, 22);
        enemyEyeball.setImage(loadImage("../assets/sprites/eyeball.png"));
        enemies.add(enemyEyeball);
        enemyEyeball = new EnemyEyeball(867, 867, 2, 100, 10, 22, 22);
        enemyEyeball.setImage(loadImage("../assets/sprites/eyeball.png"));
        enemies.add(enemyEyeball);
        enemyEyeball = new EnemyEyeball(739, 739, 2, 100, 10, 22, 22);
        enemyEyeball.setImage(loadImage("../assets/sprites/eyeball.png"));
        enemies.add(enemyEyeball);
        enemyEyeball = new EnemyEyeball(515, 515, 2, 100, 10, 22, 22);
        enemyEyeball.setImage(loadImage("../assets/sprites/eyeball.png"));
        enemies.add(enemyEyeball);
        enemyEyeball = new EnemyEyeball(611, 611, 2, 100, 10, 22, 22);
        enemyEyeball.setImage(loadImage("../assets/sprites/eyeball.png"));
        enemies.add(enemyEyeball);
        enemyEyeball = new EnemyEyeball(867, 867, 2, 100, 10, 22, 22);
        enemyEyeball.setImage(loadImage("../assets/sprites/eyeball.png"));
        ...
        enemyEyeball.setImage(loadImage("../assets/sprites/eyeball.png"));
        enemies.add(enemyEyeball);
        enemyEyeball = new EnemyEyeball(931, 931, 2, 100, 10, 22, 22);
        enemyEyeball.setImage(loadImage("../assets/sprites/eyeball.png"));
        enemies.add(enemyEyeball);
        enemyEyeball = new EnemyEyeball(995, 995, 2, 100, 10, 22, 22);
        enemyEyeball.setImage(loadImage("../assets/sprites/eyeball.png"));
        enemies.add(enemyEyeball);
        enemyEyeball = new EnemyEyeball(707, 707, 2, 100, 10, 22, 22);
        enemyEyeball.setImage(loadImage("../assets/sprites/eyeball.png"));
        enemies.add(enemyEyeball);
        enemyEyeball = new EnemyEyeball(1059, 1059, 2, 100, 10, 22, 22);
        enemyEyeball.setImage(loadImage("../assets/sprites/eyeball.png"));
        enemies.add(enemyEyeball);
        enemyEyeball = new EnemyEyeball(899, 899, 2, 100, 10, 22, 22);
        enemyEyeball.setImage(loadImage("../assets/sprites/eyeball.png"));
        enemies.add(enemyEyeball);
        enemyEyeball = new EnemyEyeball(1123, 1123, 2, 100, 10, 22, 22);
        enemyEyeball.setImage(loadImage("../assets/sprites/eyeball.png"));
        enemies.add(enemyEyeball);
        enemyEyeball = new EnemyEyeball(1315, 1315, 2, 100, 10, 22, 22);
        enemyEyeball.setImage(loadImage("../assets/sprites/eyeball.png"));
        ...
        EnemySolid enemySolid = new EnemySolid(483, 163, 2, 100, 10, 18, 24);
        enemySolid.setImage(loadImage("../assets/sprites/demon.png"));
        enemies.add(enemySolid);
        enemySolid = new EnemySolid(547, 163, 2, 100, 10, 18, 24);
        enemySolid.setImage(loadImage("../assets/sprites/demon.png"));
        enemies.add(enemySolid);
        enemySolid = new EnemySolid(483, 227, 2, 100, 10, 18, 24);
        enemySolid.setImage(loadImage("../assets/sprites/demon.png"));
        enemies.add(enemySolid);
        enemySolid = new EnemySolid(739, 227, 2, 100, 10, 18, 24);
        enemySolid.setImage(loadImage("../assets/sprites/demon.png"));
        enemies.add(enemySolid);
        enemySolid = new EnemySolid(323, 291, 2, 100, 10, 18, 24);
        enemySolid.setImage(loadImage("../assets/sprites/demon.png"));
        enemies.add(enemySolid);
        enemySolid = new EnemySolid(419, 291, 2, 100, 10, 18, 24);
        enemySolid.setImage(loadImage("../assets/sprites/demon.png"));
        enemies.add(enemySolid);
        enemySolid = new EnemySolid(291, 387, 2, 100, 10, 18, 24);
        enemySolid.setImage(loadImage("../assets/sprites/demon.png"));
        enemies.add(enemySolid);
        enemySolid = new EnemySolid(675, 419, 2, 100, 10, 18, 24);
        enemySolid.setImage(loadImage("../assets/sprites/demon.png"));
        enemies.add(enemySolid);
        enemySolid = new EnemySolid(163, 483, 2, 100, 10, 18, 24);
        enemySolid.setImage(loadImage("../assets/sprites/demon.png"));
        enemies.add(enemySolid);
        enemySolid = new EnemySolid(291, 547, 2, 100, 10, 18, 24);
        enemySolid.setImage(loadImage("../assets/sprites/demon.png"));
        enemies.add(enemySolid);
        enemySolid = new EnemySolid(611, 547, 2, 100, 10, 18, 24);
        enemySolid.setImage(loadImage("../assets/sprites/demon.png"));
        enemies.add(enemySolid);
        enemySolid = new EnemySolid(355, 611, 2, 100, 10, 18, 24);
        enemySolid.setImage(loadImage("../assets/sprites/demon.png"));
        enemies.add(enemySolid);
        enemySolid = new EnemySolid(291, 675, 2, 100, 10, 18, 24);
        enemySolid.setImage(loadImage("../assets/sprites/demon.png"));
        enemies.add(enemySolid);
        enemySolid = new EnemySolid(547, 707, 2, 100, 10, 18, 24);
        enemySolid.setImage(loadImage("../assets/sprites/demon.png"));
        enemies.add(enemySolid);
        enemySolid = new EnemySolid(419, 803, 2, 100, 10, 18, 24);
        enemySolid.setImage(loadImage("../assets/sprites/demon.png"));
        enemies.add(enemySolid);
        enemySolid = new EnemySolid(259, 931, 2, 100, 10, 18, 24);
        enemySolid.setImage(loadImage("../assets/sprites/demon.png"));
        enemies.add(enemySolid);
        enemySolid = new EnemySolid(355, 931, 2, 100, 10, 18, 24);
        enemySolid.setImage(loadImage("../assets/sprites/demon.png"));
        enemies.add(enemySolid);
        enemySolid = new EnemySolid(291, 995, 2, 100, 10, 18, 24);
        enemySolid.setImage(loadImage("../assets/sprites/demon.png"));
        enemies.add(enemySolid);
        enemySolid = new EnemySolid(483, 995, 2, 100, 10, 18, 24);
        enemySolid.setImage(loadImage("../assets/sprites/demon.png"));
        enemies.add(enemySolid);
        enemySolid = new EnemySolid(163, 1027, 2, 100, 10, 18, 24);
        enemySolid.setImage(loadImage("../assets/sprites/demon.png"));
        enemies.add(enemySolid);
