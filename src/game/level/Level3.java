...
public class Level3 extends Level {
    ...
    public void setup() {
        ...
        EnemySolid enemySolid = new EnemySolid(292, 292, 2, 100, 10, 18, 24);
        enemySolid.setImage(loadImage("../assets/sprites/demon.png"));
        enemies.add(enemySolid);
        enemySolid = new EnemySolid(548, 356, 2, 100, 10, 18, 24);
        enemySolid.setImage(loadImage("../assets/sprites/demon.png"));
        enemies.add(enemySolid);
        enemySolid = new EnemySolid(164, 420, 2, 100, 10, 18, 24);
        enemySolid.setImage(loadImage("../assets/sprites/demon.png"));
        enemies.add(enemySolid);
